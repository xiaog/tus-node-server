        ...
        return new Promise((resolve, reject) => {
            ...
            return fs.open(`${this.directory}/${file.id}`, 'w', (err, fd) => {
                ...
                return fs.close(fd, (exception) => {
                    ...
                    return this.upyun.putFile(file.extensions.remote_dir, `${this.directory}/${file.id}`, null, true, initOptions, (error, res) => {
                        if (error) {
                            return reject(error);
                        }
                        this.next_id = 0;
        ...
        return new Promise((resolve, reject) => {
            ...
            req.on('end', () => {
                ...
                return this.upyun.putFile(config.extensions.remote_dir, block, null, true, opts, (error, res) => {
                    ...
                    return this.upyun.putFile(config.extensions.remote_dir, block, null, true, opts, (err, response) => {
                        if (err) {
                            return reject(err);
                        }
